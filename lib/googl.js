...
//googl.setKey('AIzaSyDY2iT6_R7VHNCydEgSwD9nCPO5vNLjSFA');
//googl.expand('http://goo.gl/AHSc7', function (d) { console.log(d); });
//googl.shorten('http://www.htmlfivewow.com/', function (d) { console.log(d); });